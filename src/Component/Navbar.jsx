...
const [deleteUser] = useDeleteUserMutation()
  ...
  const userNavigation = [
    ...
    { name: data?.userName ? 'Sign out' : null ,  onclick:handleChanges },
    { name: data?.userName ? 'deleteUserAccount' : null , onclick:deleteUsers }
  ]
                ...
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      {/* <button
                        type="button"
                        className={classNames(cart?.length ? 'buttons' : '', 
                    ...
                    >
                       ...
                       <AiOutlineShoppingCart onClick={handleChange} className={classNames(`${cartItem ? 'text-green-100' : 'text-white'} text-3xl `)} />
                         </button> */}
